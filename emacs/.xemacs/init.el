...
;; Need global-font-lock-mode for C++ colors
...
(set-frame-height (selected-frame) 50) ; num rows
(set-frame-width (selected-frame) 80) ;  num columns
...
;;(load-library "~/Gnu/p4")
;;(p4-set-p4-executable "/sww/tools/bin/p4")
...
(setq find-file-hooks nil)		; this screws up cvs for some reason 
(tool-bar-mode nil)
;(menu-bar-mode nil)
...
(global-set-key "ESC-f" 'forward-word)
...
(autoload 'dbx "gud" "loading gud..." t)
...
(set-variable 'py-python-command "python2")
